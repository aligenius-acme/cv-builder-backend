    ...
    if (dbTemplate?.templateConfig && typeof dbTemplate.templateConfig === 'object') {
      ...
      if (modularConfig.layoutType) {
        ...
        const PALETTES: Record<string, { primary: string; secondary: string; text: string; muted: string; bg: string }> = {
          ...
          ocean:    { primary: '#0c4a6e', secondary: '#0ea5e9', text: '#0f172a', muted: '#64748b', bg: '#f0f9ff' },
          royal:    { primary: '#3730a3', secondary: '#6366f1', text: '#1e1b4b', muted: '#64748b', bg: '#ffffff' },
          slate:    { primary: '#1e293b', secondary: '#475569', text: '#0f172a', muted: '#94a3b8', bg: '#f8fafc' },
          emerald:  { primary: '#065f46', secondary: '#10b981', text: '#064e3b', muted: '#6b7280', bg: '#ffffff' },
          forest:   { primary: '#14532d', secondary: '#16a34a', text: '#052e16', muted: '#6b7280', bg: '#f0fdf4' },
          teal:     { primary: '#134e4a', secondary: '#14b8a6', text: '#0f172a', muted: '#64748b', bg: '#f0fdfa' },
          burgundy: { primary: '#881337', secondary: '#e11d48', text: '#0f172a', muted: '#64748b', bg: '#ffffff' },
          rust:     { primary: '#7c2d12', secondary: '#ea580c', text: '#1c1917', muted: '#64748b', bg: '#fff7ed' },
          wine:     { primary: '#6b21a8', secondary: '#a855f7', text: '#1e1b4b', muted: '#64748b', bg: '#faf5ff' },
          charcoal: { primary: '#111827', secondary: '#374151', text: '#111827', muted: '#6b7280', bg: '#ffffff' },
          graphite: { primary: '#374151', secondary: '#6b7280', text: '#111827', muted: '#9ca3af', bg: '#f9fafb' },
          stone:    { primary: '#44403c', secondary: '#78716c', text: '#1c1917', muted: '#a8a29e', bg: '#fafaf9' },
          violet:   { primary: '#4c1d95', secondary: '#7c3aed', text: '#1e1b4b', muted: '#64748b', bg: '#f5f3ff' },
          indigo:   { primary: '#312e81', secondary: '#4f46e5', text: '#1e1b4b', muted: '#64748b', bg: '#eef2ff' },
          plum:     { primary: '#581c87', secondary: '#9333ea', text: '#1e1b4b', muted: '#64748b', bg: '#fdf4ff' },
        };
