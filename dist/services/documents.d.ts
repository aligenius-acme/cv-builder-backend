 ...
 */
export declare function generatePDFFromRegistry(data: ParsedResumeData, templateId: string): Promise<Buffer>;
/**
 * Generate DOCX using template from registry
 * Loads template dynamically and uses React DOCX if available
 */
export declare function generateDOCXFromRegistry(data: ParsedResumeData, templateId: string): Promise<Buffer>;
